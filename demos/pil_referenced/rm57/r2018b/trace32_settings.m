...
% --------------------------------------------------------------------------------
% $Id: trace32_settings.m 3268 2018-11-22 08:58:13Z csax $
...
function  cfg = trace32_settings()
    ...
    cfg.T32_Startupscript       = 'trace32_rm57_startup.cmm';
    ...
    cfg.Stack_Profiler          = 'stack';  % Specify data for stack profiling. If empty, stack profiling is disabled.
